...
- **Microsoft.** Could build this into Azure, but their track record on developer tooling governance (Azure DevOps) suggests they'll build something adequate but not category defining.
